...
var defaults = baseRest_default(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || eq_default(value, objectProto6[key]) && !hasOwnProperty6.call(object, key)) {
...
var nativeObjectToString = objectProto9.toString;
...
var nativeObjectToString2 = objectProto10.toString;
...
function baseUnset(object, path) {
  ...
  while (++index < length) {
    ...
    if (key === "__proto__" && !hasOwnProperty10.call(object, "__proto__")) {
      return false;
    }
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6AX7RM3U.js.map
